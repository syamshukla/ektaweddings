  ...
  return (
    <section className="mx-auto grid max-w-7xl gap-16 px-5 py-16 md:grid-cols-[1fr_1.6fr] md:gap-24 md:px-10 md:py-24">
      <div>
        ...
        <h1 className="mt-4 font-serif text-5xl leading-[1.05] font-light md:text-6xl">
          Let&apos;s make something <em>worth keeping.</em>
        </h1>
        <p className="mt-8 leading-relaxed text-muted">
          Share a few details and we&apos;ll reply within two days with ideas, availability and next steps.
        </p>
        <div className="mt-10 border-t border-line pt-6 text-sm">
          <p className="eyebrow">Prefer to DM?</p>
